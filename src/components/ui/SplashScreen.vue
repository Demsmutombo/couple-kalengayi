  ...
  <Teleport to="body">
    <Transition name="splash" @after-leave="finish">
      ...
      >
        <div class="flex max-w-4xl flex-col items-center px-2 text-center">
          ...
          >
            <img
              :src="imgSrc"
              alt=""
              class="splash-logo-img max-h-48 w-auto max-w-[92vw] object-contain drop-shadow-[0_8px_40px_rgba(237,77,139,0.25)] sm:max-h-56 md:max-h-72 lg:max-h-80"
              loading="eager"
              decoding="async"
              fetchpriority="high"
              @error="onImgError"
          ...
          <p
            class="font-secondary mt-10 max-w-[95vw] text-4xl leading-tight text-secondary/95 sm:mt-12 sm:text-5xl md:mt-14 md:text-6xl lg:text-7xl"
            v-motion
        ...
        <div
          class="absolute bottom-10 left-1/2 h-1 w-24 -translate-x-1/2 overflow-hidden rounded-full bg-primary-soft/20"
          :style="progressStyle"
        >
